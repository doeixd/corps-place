    ...
    <PageShell>
      ...
      <div className="mx-auto max-w-3xl space-y-8 text-text-secondary">
        ...
        <Section heading="1. Use of the Service">
          <p>
            The Service provides scores, schedules, corps information, predictions, and related drum
            corps activity content. You may use the Service for personal, non-commercial purposes.
            You agree not to:
          </p>
        ...
        <Section heading="4. Third-Party Links and Content">
          <p>
        ...
        <Section heading="12. Copyright and Content Removal">
          <p>
