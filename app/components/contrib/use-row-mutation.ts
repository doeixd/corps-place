 ...
 * fixes the previously-uncaught `hide()` path (a rejected write — rate limit,
 * page lock, stale-write 409 — used to vanish into an unhandled rejection) and
 * removes the same boilerplate repeated in every section's row component.
 *
