...
import { ArrowDown02Icon, ArrowLeft02Icon, ArrowLeft03Icon, ArrowRight02Icon, ArrowRight03Icon, ArrowUp02Icon, PinOffIcon, SlidersHorizontalIcon, Tick02Icon, UnfoldMoreIcon } from '@/components/icons/generated';
import {
  DropdownMenu,
...
function DataGridColumnHeaderInner<TData, TValue>({
  ...
  const sortIcon =
    canSort &&
    (isSorted === 'desc' ? (
      <ArrowDown02Icon className="size-3.25" />
    ) : isSorted === 'asc' ? (
      <ArrowUp02Icon className="size-3.25" />
    ) : (
      <UnfoldMoreIcon className="mt-px size-3.25" />
    ));
  ...
  const menuItems = useMemo(() => {
    ...
    if (canSort) {
      ...
      items.push(
        ...
        >
          ...
          {isSorted === 'asc' && <Tick02Icon className="text-primary size-4 opacity-100!" />}
        </DropdownMenuItem>,
        <DropdownMenuItem
          key="sort-desc"
          onClick={() => {
        ...
        >
          ...
          {isSorted === 'desc' && <Tick02Icon className="text-primary size-4 opacity-100!" />}
        </DropdownMenuItem>
      );
      hasPreviousSection = true;
    }
    ...
    if (props.tableLayout?.columnsPinnable && canPin) {
      ...
      items.push(
        ...
        >
          ...
          {isPinned === 'left' && <Tick02Icon className="text-primary size-4 opacity-100!" />}
        </DropdownMenuItem>,
        <DropdownMenuItem
          key="pin-right"
        ...
        >
          ...
          {isPinned === 'right' && <Tick02Icon className="text-primary size-4 opacity-100!" />}
        </DropdownMenuItem>
      );
      hasPreviousSection = true;
    }
    ...
    if (props.tableLayout?.columnsMovable) {
      ...
      items.push(
        ...
        >
          <ArrowLeft02Icon className="size-3.5!" aria-hidden="true" />
        ...
        >
          <ArrowRight02Icon className="size-3.5!" aria-hidden="true" />
