...
export function BookmarkButton({
  ...
  // Native title (not a base-ui Tooltip) for this hint — keeps the base-ui
  // tooltip + floating-ui stack (~80KB) off every product-grid page, since this
  // button renders on every card. aria-label already covers assistive tech.
  return (
    <button
      type="button"
      aria-label={label}
