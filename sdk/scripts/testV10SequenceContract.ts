...
const summary = sqlite<Record<string, number>>(`SELECT
  ...
  SUM(CASE WHEN reference_curves_version<>'v10-clean-artifacts-dev1' THEN 1 ELSE 0 END) AS bad_curves,
  SUM(CASE WHEN map_version<>'v10-clean-artifacts-dev1' THEN 1 ELSE 0 END) AS bad_maps
...
const artifactDir = "./src/training/v10/dev1";
