...
Session: results\ablation\v9-subcaption-ablation-20260206-083850
Started: 2026-02-06T13:38:50.723Z

## v9fix_ctrl (interval-control)
...
## v9fix_idfloor0 (identity-floor)

- Dry run only; command not executed.

## v9fix_trunk256 (accuracy-trunk)

- Dry run only; command not executed.

## v9fix_mbmp14 (mbmp-emphasis)
