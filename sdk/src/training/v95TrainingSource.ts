...
const coreFiles = [
  ...
  "src/training/v10IdentitySupport.ts",
  "src/training/v10/dev2/manifest.json",
  "src/training/v10/dev2/referenceCurves.json",
  "src/training/v10/dev2/judgeIndexMap.json",
  "src/training/v10/dev2/corpsIndexMap.json",
  "src/training/v10/dev2/corpsAliasMap.json",
  ...
  "src/training/baselines/v10-sequences-dev2.json",
