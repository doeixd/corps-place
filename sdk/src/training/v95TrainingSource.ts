...
const coreFiles = [
  ...
  "src/training/v10/dev3/manifest.json",
  "src/training/v10/dev3/referenceCurves.json",
  "src/training/v10/dev3/judgeIndexMap.json",
  "src/training/v10/dev3/corpsIndexMap.json",
  "src/training/v10/dev3/corpsAliasMap.json",
  ...
  "src/training/baselines/v10-sequences-dev3.json",
