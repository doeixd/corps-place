...
const MODEL_DIR = "./models/v6_finals_blind";
const NORM_PATH = "./results/v6-finals-blind-target-norm.json";
const SEQ_LEN = 15;
const FEAT_DIM = 57;
const STATIC_DIM = 53;
const BATCH_SIZE = 32;
...
function parseArgs() {
  ...
  return {
    ...
    // Logging
    logCsv: get("--log-csv", "./results/lstm-v6-finals-blind-training-log.csv"),
...
async function main() {
  ...
  if (!trainSubset.length || !valSubset.length) {
    throw new Error("Missing train/val data for V6 Finals Blind model.");
  }
