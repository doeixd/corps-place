...
export const V10_PROFILES: Readonly<Record<V10ProfileName, V10Profile>> = {
  "clean-data-control": {
    modelVersion: "v10-clean-control-dev3",
    parentModel: "v9.5-final2-compatible",
    dataContract: "v10-sequence-contract-dev3",
  ...
  "field-pace": {
    modelVersion: "v10-field-pace-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
  ...
  "thin-history": {
    modelVersion: "v10-thin-history-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
  ...
  "support-aware-identity": {
    modelVersion: "v10-support-aware-identity-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
  ...
  "scaled-control": {
    modelVersion: "v10-scaled-control-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
    featureProfile: "v9.5-220-control",
    mlTable: "ml_sequence_rows_v10_clean_control",
  ...
  "phase-aware-lr": {
    modelVersion: "v10-phase-aware-lr-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
    featureProfile: "v9.5-220-control",
    mlTable: "ml_sequence_rows_v10_clean_control",
  ...
  "smooth-sequence": {
    modelVersion: "v10-smooth-sequence-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
    featureProfile: "v9.5-220-control",
    mlTable: "ml_sequence_rows_v10_clean_control",
  ...
  "phase-b-total-weight": {
    modelVersion: "v10-phase-b-total-weight-dev3",
    parentModel: "v10-clean-control-dev3",
    dataContract: "v10-sequence-contract-dev3",
    featureProfile: "v9.5-220-control",
    mlTable: "ml_sequence_rows_v10_clean_control",
  ...
  "combined-candidate": {
    modelVersion: "v10-combined-candidate-dev3",
...
export const v10DefaultArgs = (profileName: V10ProfileName, seed = 43): string[] => {
  ...
  return [
    ...
    "--judge-map", "./src/training/v10/dev3/judgeIndexMap.json",
    "--corps-map", "./src/training/v10/dev3/corpsIndexMap.json",
    "--show-map", "./src/training/v10/dev3/showIndexMap.json",
    "--identity-support", "./src/training/v10/dev3/identitySupport.json",
